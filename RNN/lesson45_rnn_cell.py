# -*- coding: utf-8 -*-
# @Time    : 2019-11-13 10:21
# @Author  : RichardoMu
# @File    : lesson45_rnn_cell.py
# @Software: PyCharm
...
class MyRNN(keras.Model):
    ...
    def __init__(self,units):
        ...
        self.rnncell0 = layers.SimpleRNNCell(units=units,dropout=0.2)
        self.rnncell1 = layers.SimpleRNNCell(units=units,dropout=0.2)
